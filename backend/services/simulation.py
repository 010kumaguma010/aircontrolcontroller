...
# 室内発熱 (kW固定) - 居住者1名+PC等の電子機器を想定
OCCUPANT_LOAD_KW = 0.3
# 熱容量係数 (kJ/℃/畳)
...
def build_response(
    ...
    result = simulate(current_temp, target_temp, outside_temp, tatami_size, aircon_kw, insulation_level)
    ...
    start_dt = arrival_dt - timedelta(minutes=duration_min)
    switch_dt = start_dt + timedelta(minutes=duration_min)
